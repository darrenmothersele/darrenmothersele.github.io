...
if(isset($_POST['email'])) {
	...
	$transport->setUsername('darren@darrenmothersele.com');
  $transport->setPassword('os1EzViSRHsJ3KwwUSf8tw');
	...
	$message = Swift_Message::newInstance('A message from my website')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('darren@darrenmothersele.com' => 'Darren Mothersele'))->setBody($messageText);
//                           ^                    ^
